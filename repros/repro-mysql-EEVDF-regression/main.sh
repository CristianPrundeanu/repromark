...
function scenario:run:sut()
{
    repro:persistent_steps ${SCENARIO_NAME} <<-EOT
        ...
        scenario:run_mysql "MySQL on default kernel 6.13-rc4" k6.13 6.13.0-rc4 SCHED_OTHER PLACE_LAG RUN_TO_PARITY
        scenario:run_mysql "MySQL on kernel 6.13-rc4 NO_PLACE_LAG NO_RUN_TO_PARITY" k6.13-NOx2 6.13.0-rc4 SCHED_OTHER NO_PLACE_LAG NO_RUN_TO_PARITY
        scenario:run_mysql "MySQL on kernel 6.13-rc4 SCHED_BATCH" k6.13-batch 6.13.0-rc4 SCHED_BATCH PLACE_LAG RUN_TO_PARITY
